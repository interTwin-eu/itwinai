...
def distributed(func):
    def dist_train(model, train_dataloader,
                   validation_dataloader=None, device='cpu',
                   *args, **kwargs):
        ...
        try:
            func(model, train_dataloader, validation_dataloader, *args,
