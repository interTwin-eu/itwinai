...
from src.neural_network_models import (
    UNet,
    CustomLossUNet,
    OneDconvEncoder,
...
class PulsarTrainer(TrainImageToMaskNetworkModel,ImageToMaskDataset,InMaskToMaskDataset,TorchTrainer):
    """Trainer class for radio-astronomy use-case. 
       Inherited from itwinai TorchTrainer class, as well as multiple
       trainer classes from pulsa_analysis module.
    """
    def __init__(
        self,
        num_epochs: int = 3,
        model: nn.Module = None,
        loss_criterion: nn.Module = None,  # from pulsar_analysis
        write_model: str = ".models/model.pt",
