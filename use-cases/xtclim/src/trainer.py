...
class XTClimTrainer(TorchTrainer):
    ...
    def execute(self):
        ...
        for season in seasons:
            ...
            trainloader = self.strategy.create_dataloader(trainset, batch_size=self.batch_size,
            ...
            testloader = self.strategy.create_dataloader(testset, batch_size=self.batch_size,
            ...
            for epoch in range(self.epochs):
                ...
                if self.strategy.is_main_worker:
                    ...
                    if self.config.save_best and avg_loss < min_valid_epoch_loss:
                        ...
                        # the previous ones
                        checkpoint_filename = f"outputs/cvae_model_{season}1d_{n_memb}memb.pth"
