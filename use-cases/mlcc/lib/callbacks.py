...
class ProcessBenchmark(tf.keras.callbacks.Callback):
    """
    Gets several benchmarks parameters about the process during the training, including execution time.
    ...
    def __init__(self, filename):
        ...
        # get initial process cpu percent, so that the next call returns the correct cpu percentage
