...
# DeepSpeed
# export DS_BUILD_CCL_COMM=1 # temporarily disabled. Needs to br installed: https://github.com/intel/torch-ccl?tab=readme-ov-file#install-prebuilt-wheel and https://github.com/oneapi-src/oneCCL?tab=readme-ov-file#installation
