...
if [[ "$(uname)" == "Darwin" ]]; then
  pip install --no-cache-dir "prov4ml[apple]@git+https://github.com/matbun/ProvML@v0.0.2"
else
  # Assuming Nvidia GPUs are available
  pip install --no-cache-dir "prov4ml[nvidia]@git+https://github.com/matbun/ProvML@v0.0.2"
fi